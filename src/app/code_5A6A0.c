...
s32 func_802D4CA4(Unk802D3658_Arg0*, Mtx4F_t);
void func_802D58EC(Unk802D3658_Arg0*, Mtx4F_t);
s32 func_802DB050(s32*, s32*, u16, u8, Mtx4F_t);
s32 func_802DB224(s32*, s32, u16, u8, Vec3F_t*, Vec3F_t*);
void func_802DBE64(void*, void*, s32, Mtx4F_t);
void func_802DCA5C(Vec3F_t*, Vec3F_t*, Vec3F_t*, Vec3F_t*, Vec3F_t*);
f32 func_802E1754(f32, f32, f32, Vec3F_t*);
void func_802EAAE0(Unk802D3658_Unk230*);
void func_802EABAC(Unk802D3658_Unk230*, f32, Mtx4F_t);
void func_802EAC18(Unk802D3658_Unk230*, f32, Mtx4F_t);
void func_802EAC9C(Unk802D3658_Unk230*, f32, Mtx4F_t);
void func_803134D0(f32, f32, f32, f32*, f32*, f32*);
void func_803138A0(MtxF*, Mtx4F_t, Mtx4F_t, f32);
f32 func_80313AF4(f32, f32, f32);
void func_80313E18(Vec3F_t*, Mtx4F_t);
f32 func_80313F08(Unk803599D0*, f32);
f32 func_803232A0(void);
void func_8034ABB0(Mtx4F_t, Vec3F_t*, Vec3F_t*);
void func_8034AD6C(f32, f32, f32, Mtx4F_t);
void func_8034B210(Vec3F_t, Vec3F_t, Mtx4F_t);
void func_8034B2B0(Vec3F_t*);
void func_8034B4DC(Vec3F_t, Mtx4F_t);
...
void func_802D3170(u8 arg0, Unk802D3658_Arg0* arg1) {
    ...
    arg1->unk1A0 = 0.1f;
    arg1->unk137C = 0;
    arg1->unk108.mf[3][2] = 0.0f;
    arg1->unk1380 = 0.0f;
    arg1->unk1374 = 6.0f;
    arg1->unk1378 = 30.0f;
    uvMat4SetIdentity(arg1->unk80.mf);
...
void func_802D3444(Unk802D3658_Arg0* arg0) {
    ...
    if (arg0->unk1 != 5) {
        uvMat4Copy(sp28.mf, arg0->unk80.mf);
        uvMat4UnkOp2(sp28.mf, arg0->unk5C, arg0->unk60, arg0->unk64);
        func_802EAC18(arg0->unk230, arg0->unk14, sp28.mf);
        if (arg0->unkD != 0) {
            func_802EABAC(arg0->unk230, arg0->unk14, sp28.mf);
            arg0->unkD = 0;
        }
        arg0->unk1AC = func_8022A27C(arg0->unk80.mf[0][0], arg0->unk80.mf[0][1]) - 1.5707963f; // almost DEG_TO_RAD(90)
...
void func_802D3658(Unk802D3658_Arg0* arg0) {
    ...
    temp_fa0 = SqrtF(SQ(arg0->unk108.mf[3][0] - arg0->unk80.mf[3][0]) + SQ(arg0->unk108.mf[3][1] - arg0->unk80.mf[3][1]) +
               ...
               (2.0f * arg0->unk54);
    if (temp_fa0 < 0.0f) {
        arg0->unk108.mf[3][0] += arg0->unk108.mf[1][0] * temp_fa0;
        arg0->unk108.mf[3][1] += arg0->unk108.mf[1][1] * temp_fa0;
        arg0->unk108.mf[3][2] += arg0->unk108.mf[1][2] * temp_fa0;
        (void)func_802D472C(arg0, arg0->unk108.mf);
    }
    if (arg0->unk0 & 0x08) {
        (void)func_802D472C(arg0, arg0->unk108.mf);
    }
    if (arg0->unk0 & 0x20) {
        (void)func_802D4A30(arg0, arg0->unk108.mf);
    }
    if (arg0->unk0 & 0x40) {
        (void)func_802D4CA4(arg0, arg0->unk108.mf);
    }
}
...
void func_802D3790(Unk802D3658_Arg0* arg0) {
    ...
    spBC.x = arg0->unk80.mf[3][0];
    spBC.y = arg0->unk80.mf[3][1];
    spBC.z = arg0->unk80.mf[3][2];
    spB0.x = arg0->unkC0;
    spB0.y = 0.0f;
    spB0.z = 0.0f;
    func_8034B210(spBC, spB0, sp4C.mf);
    sp8C.x = 0.0f;
    sp8C.z = 0.0f;
    sp8C.y = -1.0f;
    func_8034ABB0(sp4C.mf, &sp98, &sp8C);
    func_8034B2B0(&sp98);
    if (arg0->unk137C == 0) {
        ...
        func_8034B4DC(sp98, arg0->unk108.mf);
        arg0->unk108.mf[3][0] = spA4.x;
        arg0->unk108.mf[3][1] = spA4.y;
        arg0->unk108.mf[3][2] = spA4.z;
        uvMat4RotateAxis(arg0->unk108.mf, arg0->unk78 * 0.5f, 'z');
        uvMat4RotateAxis(arg0->unk108.mf, arg0->unk7C * 0.5f, 'x');
        func_802D58EC(arg0, arg0->unk108.mf);
        if (arg0->unk0 & 0x08) {
            func_802D472C(arg0, arg0->unk108.mf);
        }
        if (arg0->unk0 & 0x20) {
            func_802D4A30(arg0, arg0->unk108.mf);
        }
        if (arg0->unk0 & 0x40) {
            func_802D4CA4(arg0, arg0->unk108.mf);
        }
    } else if (arg0->unk137C == 1) {
        func_8034AD6C(arg0->unkC0, 0.0f, 0.0f, arg0->unk108.mf);
        arg0->unk108.mf[3][0] = spBC.x;
        arg0->unk108.mf[3][1] = spBC.y;
        arg0->unk108.mf[3][2] = spBC.z;
        uvMat4UnkOp2(arg0->unk108.mf, arg0->unk68, arg0->unk6C, arg0->unk70);
        uvMat4RotateAxis(arg0->unk108.mf, arg0->unk78 * 0.5f, 'z');
        uvMat4RotateAxis(arg0->unk108.mf, arg0->unk7C * 0.5f, 'x');
    }

    temp_fv0 = SqrtF(SQ(arg0->unk108.mf[0][0]) + SQ(arg0->unk108.mf[0][1]) + SQ(arg0->unk108.mf[0][2]));
    arg0->unk108.mf[0][0] /= temp_fv0;
    arg0->unk108.mf[0][1] /= temp_fv0;
    arg0->unk108.mf[0][2] /= temp_fv0;

    temp_fv0 = SqrtF(SQ(arg0->unk108.mf[1][0]) + SQ(arg0->unk108.mf[1][1]) + SQ(arg0->unk108.mf[1][2]));
    arg0->unk108.mf[1][0] /= temp_fv0;
    arg0->unk108.mf[1][1] /= temp_fv0;
    arg0->unk108.mf[1][2] /= temp_fv0;

    temp_fv0 = SqrtF(SQ(arg0->unk108.mf[2][0]) + SQ(arg0->unk108.mf[2][1]) + SQ(arg0->unk108.mf[2][2]));
    arg0->unk108.mf[2][0] /= temp_fv0;
    arg0->unk108.mf[2][1] /= temp_fv0;
    arg0->unk108.mf[2][2] /= temp_fv0;
}
...
void func_802D3FA4(Unk802D3658_Arg0* arg0) {
    ...
    uvMat4Copy(arg0->unk108.mf, arg0->unk80.mf);
    uvMat4UnkOp2(arg0->unk108.mf, arg0->unk68, arg0->unk6C, arg0->unk70);
    uvMat4RotateAxis(arg0->unk108.mf, arg0->unk74, 'x');
    if (arg0->unk0 & 0x04) {
        sp24.x = arg0->unk108.mf[2][0] * 0.2f;
        sp24.y = arg0->unk108.mf[2][1] * 0.2f;
        sp24.z = (arg0->unk108.mf[2][2] * 0.2f) + 0.8f;
        uvVec3Normal(&sp24, &sp24);
        func_80313E18(&sp24, arg0->unk108.mf);
    }
    uvMat4RotateAxis(arg0->unk108.mf, arg0->unk78, 'z');
    uvMat4RotateAxis(arg0->unk108.mf, arg0->unk7C, 'x');
    (void)func_802D4A30(arg0, arg0->unk108.mf);
}
...
s32 func_802D408C(Unk802D3658_Arg0* arg0) {
    ...
    argX = arg0->unk80.mf[3][0];
    argY = arg0->unk80.mf[3][1];
    argZ = arg0->unk80.mf[3][2];
    ...
    if (i < countOBSV) {
        arg0->unk1 = 2;
        uvMat4SetIdentity(arg0->unk14C.mf);
        arg0->unk14C.mf[3][0] = sp58[i].x;
        arg0->unk14C.mf[3][1] = sp58[i].y;
        arg0->unk14C.mf[3][2] = sp58[i].z;
        arg0->unk148 = 1;
        return 1;
    }
    arg0->unk148 = 0;
...
s32 func_802D472C(Unk802D3658_Arg0* arg0, Mtx4F_t arg1) {
    f32 temp_fv0;
    f32 temp_fv1;
    Vec3F_t sp1B4;
    Vec3F_t sp1A8;
    ...
    sp1A8.x = arg0->unk80.mf[3][0];
    sp1A8.y = arg0->unk80.mf[3][1];
    sp1A8.z = arg0->unk80.mf[3][2];
...
s32 func_802D4A30(Unk802D3658_Arg0* arg0, Mtx4F_t arg1) {
    s32 sp2A4;
    u8 pad[0x144];
    ...
    uvMat4Copy(spF0.mf, arg1);
    spF0.mf[3][1] = 0.0f;
    spF0.mf[3][0] = 0.0f;
    spF0.mf[3][2] = 0.0f;
    uvMat4UnkOp4(spB0.mf, spF0.mf);

    for (i = 0; i < sp2A4; i++) {
        var_s3 = &arg0->unk1228[i];
        temp_s2 = &arg0->unk1120[var_s3->unk0];
        func_802DBE64(&arg0->unk111C, &arg0->unk1224, i, spB0.mf);
        func_802DCA5C(&temp_s2->unk28, &temp_s2->unk1C, &var_s3->unk28, &var_s3->unk34, &sp148);
        sp13C.x = arg1[3][0] + (arg1[1][0] * 1.5f * arg0->unk3C);
        sp13C.y = arg1[3][1] + (arg1[1][1] * 1.5f * arg0->unk3C);
        sp13C.z = arg1[3][2] + (arg1[1][2] * 1.5f * arg0->unk3C);
        uvMat4Copy(sp70.mf, arg1);
        uvMat4UnkOp2(sp70.mf, sp148.x, sp148.y, sp148.z);
        sp130.x = sp70.mf[3][0] + (arg1[1][0] * 1.5f * arg0->unk3C);
        sp130.y = sp70.mf[3][1] + (arg1[1][1] * 1.5f * arg0->unk3C);
        sp130.z = sp70.mf[3][2] + (arg1[1][2] * 1.5f * arg0->unk3C);
...
s32 func_802D4CA4(Unk802D3658_Arg0* arg0, Mtx4F_t arg1) {
    MtxF sp30;
    f32 temp_fa1;
    f32 temp_fv0;
    f32 temp_fv1;
    ...
    if ((D_8034F850 - arg0->unk18) > 0.5f) {
        temp_fv0 = arg1[3][0] - arg0->unk80.mf[3][0];
        temp_fv1 = arg1[3][1] - arg0->unk80.mf[3][1];
        temp_fa1 = arg1[3][2] - arg0->unk80.mf[3][2];
        if (arg0->unk8 < SqrtF(SQ(temp_fv0) + SQ(temp_fv1) + SQ(temp_fa1))) {
            return 0;
        }
        arg0->unk18 = D_8034F850;
    }
    uvMat4SetIdentity(sp30.mf);
...
void func_802D4DE8(Unk802D3658_Arg0* arg0, u8 arg1) {
    ...
    if (!arg1) {
        ...
        arg0->unk1A0 = 0.1f;
        arg0->unk1FC = -100.0f;
        uvMat4Copy(sp20, arg0->unk80.mf);
        uvMat4UnkOp2(sp20, arg0->unk5C, arg0->unk60, arg0->unk64);
        func_802EABAC(arg0->unk230, 0.0f, sp20);
        uvMat4Copy(sp20, arg0->unk1BC.mf);
        arg0->unk1114 = 1;
        arg0->unkF++;
    }
}

void func_802D4ECC(Unk802D3658_Arg0* arg0, Mtx4F_t arg1) {
    f32 z;
    f32 x;
    f32 y;
    s32 i;
    ...
    x = arg1[3][0] - arg0->unk80.mf[3][0];
    y = arg1[3][1] - arg0->unk80.mf[3][1];
    z = arg1[3][2] - arg0->unk80.mf[3][2];
...
void func_802D50D0(Unk802D3658_Arg0* arg0) {
    ...
    if ((arg0->unk1 == 5) || (D_80362690->unk0[0].unk0 != 5)) {
        ...
        if (arg0->unk1 == 1) {
            ...
            temp_fv0_2 = arg0->unk108.mf[3][0] - arg0->unk80.mf[3][0];
            temp_fv1 = arg0->unk108.mf[3][1] - arg0->unk80.mf[3][1];
            temp_fa1 = arg0->unk108.mf[3][2] - arg0->unk80.mf[3][2];
...
void func_802D532C(Unk802D3658_Arg0* arg0) {
    ...
    uvMat4SetIdentity(sp80.mf);
    sp80.mf[3][0] = arg0->unk80.mf[3][0];
    sp80.mf[3][1] = arg0->unk80.mf[3][1];
    sp80.mf[3][2] = arg0->unk80.mf[3][2];
    ...
    uvMat4RotateAxis(sp80.mf, -var_fa0_2, 'z');
    uvMat4RotateAxis(sp80.mf, -arg0->unk1B0, 'x');
    uvMat4UnkOp2(sp80.mf, 0.0f, -arg0->unk1B4, 0.0f);
    if (arg0->unk0 & 0x08) {
        sp38 = func_802D472C(arg0, sp80.mf);
    }
    if (arg0->unk0 & 0x20) {
        sp34 = func_802D4A30(arg0, sp80.mf);
    }
    if ((arg0->unk0 & 0x40) && (sp34 != -1)) {
        sp30 = func_802D4CA4(arg0, sp80.mf);
    }
    if (sp34 == -1) {
        arg0->unk1FC = D_8034F850;
    }
    if ((D_8034F850 - arg0->unk1FC) < 2.0f) {
        uvMat4Copy(sp80.mf, arg0->unk1BC.mf);
    }
    if ((sp38 == 0) && (sp34 == 0) && (sp30 == 0)) {
        uvMat4Copy(arg0->unk1BC.mf, sp80.mf);
    }
    if (arg0->unk1 == 7) {
        uvMat4Copy(sp40.mf, arg0->unk80.mf);
...
void func_802D559C(Unk802D3658_Arg0* arg0) {
    ...
    if ((D_8034F850 - arg0->unk200) > 3.0f) {
        ...
        if (temp_fv0 > 0.0f) {
            ...
            arg0->unk210.x = arg0->unk80.mf[3][0] + ((arg0->unk204.x / temp_fv0) * temp_fa0);
            arg0->unk210.y = arg0->unk80.mf[3][1] + ((arg0->unk204.y / temp_fv0) * temp_fa0);
            arg0->unk210.z = arg0->unk80.mf[3][2] + ((arg0->unk204.z / temp_fv0) * temp_fa0);
            if (func_803232A0() > 0.5f) {
                arg0->unk210.x += 2.0f * arg0->unk80.mf[0][0];
                arg0->unk210.y += 2.0f * arg0->unk80.mf[0][1];
            } else {
                arg0->unk210.x -= 2.0f * arg0->unk80.mf[0][0];
                arg0->unk210.y -= 2.0f * arg0->unk80.mf[0][1];
            }
            ...
            arg0->unk210.x = arg0->unk80.mf[3][0] + (arg0->unk108.mf[1][0] * 10.0f);
            arg0->unk210.y = arg0->unk80.mf[3][1] + (arg0->unk108.mf[1][1] * 10.0f);
            arg0->unk210.z = arg0->unk80.mf[3][2] + (arg0->unk108.mf[1][2] * 10.0f);
        }
    }
    uvMat4SetIdentity(sp48.mf);
    sp48.mf[3][0] = arg0->unk210.x;
    sp48.mf[3][1] = arg0->unk210.y;
    sp48.mf[3][2] = arg0->unk210.z;
    tmpX = sp48.mf[3][0] - arg0->unk80.mf[3][0];
    tmpY = sp48.mf[3][1] - arg0->unk80.mf[3][1];
    tmpZ = sp48.mf[3][2] - arg0->unk80.mf[3][2];
...
void func_802D5884(Unk802D3658_Arg0* arg0, u8 arg1) {
    if (arg1 != arg0->unk1) {
        ...
        if (arg1 == 3) {
            ...
            arg0->unk194 = func_8022A27C(arg0->unk80.mf[0][0], arg0->unk80.mf[0][1]);
            arg0->unkE = 1;
        }
    }
}

void func_802D58EC(Unk802D3658_Arg0* arg0, Mtx4F_t arg1) {
    MtxF sp88; // 88:C7
    MtxF sp48; // 48:87
    Vec3F_t sp3C;
    Vec3F_t sp30;
    ...
    func_802E1754(arg1[3][0], arg1[3][1], arg1[3][2], &sp3C);
    uvMat4Copy(sp88.mf, arg1);
    sp88.mf[3][0] = sp88.mf[3][1] = sp88.mf[3][2] = 0.0f;

    uvMat4UnkOp4(sp48.mf, sp88.mf);
    uvMat4UnkOp5(sp48.mf, &sp30, &sp3C);
