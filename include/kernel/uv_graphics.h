...
#define OVERSCAN_LEFT 10
#define OVERSCAN_RIGHT 10
#define OVERSCAN_TOP 8
#define OVERSCAN_BOTTOM 18

#define SUBSCREEN_X0 (OVERSCAN_LEFT)
#define SUBSCREEN_Y0 (OVERSCAN_BOTTOM)
#define SUBSCREEN_X1 (SCREEN_WIDTH - OVERSCAN_RIGHT)
#define SUBSCREEN_Y1 (SCREEN_HEIGHT - OVERSCAN_TOP)
